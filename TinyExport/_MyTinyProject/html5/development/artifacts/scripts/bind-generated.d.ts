...
declare namespace game{
    ...
    class GameManager extends ut.Component {
        constructor();
        static readonly cid: number;
        static readonly _view: any;
        static readonly _isSharedComp: boolean;
        static _size: number;
        static _fromPtr(p: number, v?: GameManager): GameManager;
        static _toPtr(p: number, v: GameManager): void;
        static _tempHeapPtr(v: GameManager): number;
        static _dtorFn(v: GameManager): void;
    }
    enum State {
        WAIT = 0,
        GET_JUDGE_CARD = 1,
...
declare namespace ut{
    ...
    interface EntityGroups{
        ...
        game: {
            ...
            CardsInHand: EntityGroupData;
            CardsPlayed: EntityGroupData;
